...
export declare namespace ConfigProvider {
    ...
    interface Flat {
        ...
        load<A>(path: ReadonlyArray<string>, config: Config.Config.Primitive<A>, split?: boolean): Effect.Effect<ReadonlyArray<A>, ConfigError.ConfigError>;
...
export declare const makeFlat: (options: {
    readonly load: <A>(path: ReadonlyArray<string>, config: Config.Config.Primitive<A>, split: boolean) => Effect.Effect<ReadonlyArray<A>, ConfigError.ConfigError>;
