 ...
 */
type FunctionReference<TArgs extends any[], TReturn> = (...args: TArgs) => TReturn;
/**
 * Default type.
 */
...
interface BaseSchema<TInput, TOutput, TIssue extends BaseIssue<unknown>> {
     ...
     * The schema reference.
     */
    readonly reference: FunctionReference<any[], BaseSchema<unknown, unknown, BaseIssue<unknown>>>;
    /**
     * The expected property.
     */
    readonly expects: string;
...
interface BaseSchemaAsync<TInput, TOutput, TIssue extends BaseIssue<unknown>> extends Omit<BaseSchema<TInput, TOutput, TIssue>, 'reference' | 'async' | '_run'> {
     ...
     * The schema reference.
     */
    readonly reference: FunctionReference<any[], BaseSchema<unknown, unknown, BaseIssue<unknown>> | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>>;
    /**
     * Whether it's async.
     */
    readonly async: true;
...
interface BaseTransformation<TInput, TOutput, TIssue extends BaseIssue<unknown>> {
     ...
     */
    readonly reference: FunctionReference<any[], BaseTransformation<unknown, unknown, BaseIssue<unknown>>>;
    /**
     * Whether it's async.
     */
    readonly async: false;
...
interface BaseTransformationAsync<TInput, TOutput, TIssue extends BaseIssue<unknown>> extends Omit<BaseTransformation<TInput, TOutput, TIssue>, 'reference' | 'async' | '_run'> {
     ...
     * The transformation reference.
     */
    readonly reference: FunctionReference<any[], BaseTransformation<unknown, unknown, BaseIssue<unknown>> | BaseTransformationAsync<unknown, unknown, BaseIssue<unknown>>>;
    /**
     * Whether it's async.
     */
    readonly async: true;
...
interface BaseValidation<TInput, TOutput, TIssue extends BaseIssue<unknown>> {
     ...
     */
    readonly reference: FunctionReference<any[], BaseValidation<unknown, unknown, BaseIssue<unknown>>>;
    /**
     * The expected property.
     */
...
interface BaseValidationAsync<TInput, TOutput, TIssue extends BaseIssue<unknown>> extends Omit<BaseValidation<TInput, TOutput, TIssue>, 'reference' | 'async' | '_run'> {
     ...
     * The validation reference.
     */
    readonly reference: FunctionReference<any[], BaseValidation<unknown, unknown, BaseIssue<unknown>> | BaseValidationAsync<unknown, unknown, BaseIssue<unknown>>>;
    /**
     * Whether it's async.
     */
    readonly async: true;
 ...
 */
type ArrayRequirement<TInput extends readonly unknown[]> = (item: TInput[number], index: number, array: TInput) => boolean;
/**
 * Content input type.
 */
 ...
 */
interface CheckItemsIssue<TInput extends readonly unknown[]> extends BaseIssue<TInput[number]> {
    /**
     * The issue kind.
     */
    readonly kind: 'validation';
 ...
 */
interface CheckItemsAction<TInput extends readonly unknown[], TMessage extends ErrorMessage<CheckItemsIssue<TInput>> | undefined> extends BaseValidation<TInput, TInput, CheckItemsIssue<TInput>> {
    /**
     * The action type.
     */
    readonly type: 'check_items';
 ...
 */
declare function checkItems<TInput extends readonly unknown[]>(requirement: ArrayRequirement<TInput>): CheckItemsAction<TInput, undefined>;
/**
 * Creates an check items validation action.
 *
 * @param requirement The validation function.
 ...
 * @returns An check items action.
 */
declare function checkItems<TInput extends readonly unknown[], const TMessage extends ErrorMessage<CheckItemsIssue<TInput>> | undefined>(requirement: ArrayRequirement<TInput>, message: TMessage): CheckItemsAction<TInput, TMessage>;
 ...
 */
interface EveryItemIssue<TInput extends readonly unknown[]> extends BaseIssue<TInput> {
    /**
     * The issue kind.
     */
    readonly kind: 'validation';
 ...
 */
interface EveryItemAction<TInput extends readonly unknown[], TMessage extends ErrorMessage<EveryItemIssue<TInput>> | undefined> extends BaseValidation<TInput, TInput, EveryItemIssue<TInput>> {
    /**
     * The action type.
     */
    readonly type: 'every_item';
 ...
 */
declare function everyItem<TInput extends readonly unknown[]>(requirement: ArrayRequirement<TInput>): EveryItemAction<TInput, undefined>;
/**
 * Creates an every item validation action.
 *
 * @param requirement The validation function.
 ...
 * @returns An every item action.
 */
declare function everyItem<TInput extends readonly unknown[], const TMessage extends ErrorMessage<EveryItemIssue<TInput>> | undefined>(requirement: ArrayRequirement<TInput>, message: TMessage): EveryItemAction<TInput, TMessage>;
 ...
 */
interface FilterItemsAction<TInput extends readonly unknown[]> extends BaseTransformation<TInput, TInput, never> {
    /**
     * The action type.
     */
 ...
 */
declare function filterItems<TInput extends readonly unknown[]>(operation: ArrayRequirement<TInput>): FilterItemsAction<TInput>;

/**
 * Find item action type.
 */
interface FindItemAction<TInput extends readonly unknown[]> extends BaseTransformation<TInput, TInput[number] | undefined, never> {
    /**
     * The action type.
     */
 ...
 */
declare function findItem<TInput extends readonly unknown[]>(operation: ArrayRequirement<TInput>): FindItemAction<TInput>;
 ...
 * Array action type.
 */
type ArrayAction$2<TInput extends readonly unknown[], TOutput> = (item: TInput[number], index: number, array: TInput) => TOutput;
/**
 * Map items action type.
 */
interface MapItemsAction<TInput extends readonly unknown[], TOutput> extends BaseTransformation<TInput, TOutput[], never> {
    /**
     * The action type.
     */
 ...
 */
declare function mapItems<TInput extends readonly unknown[], TOutput>(operation: ArrayAction$2<TInput, TOutput>): MapItemsAction<TInput, TOutput>;
 ...
 * Array action type.
 */
type ArrayAction$1<TInput extends readonly unknown[], TOutput> = (output: TOutput, item: TInput[number], index: number, array: TInput) => TOutput;
/**
 * Reduce items action type.
 */
interface ReduceItemsAction<TInput extends readonly unknown[], TOutput> extends BaseTransformation<TInput, TOutput, never> {
    /**
     * The action type.
     */
 ...
 */
declare function reduceItems<TInput extends readonly unknown[], TOutput>(operation: ArrayAction$1<TInput, TOutput>, initial: TOutput): ReduceItemsAction<TInput, TOutput>;
 ...
 */
interface SomeItemIssue<TInput extends readonly unknown[]> extends BaseIssue<TInput> {
    /**
     * The issue kind.
     */
    readonly kind: 'validation';
 ...
 */
interface SomeItemAction<TInput extends readonly unknown[], TMessage extends ErrorMessage<SomeItemIssue<TInput>> | undefined> extends BaseValidation<TInput, TInput, SomeItemIssue<TInput>> {
    /**
     * The action type.
     */
    readonly type: 'some_item';
 ...
 */
declare function someItem<TInput extends readonly unknown[]>(requirement: ArrayRequirement<TInput>): SomeItemAction<TInput, undefined>;
/**
 * Creates a some item validation action.
 *
 * @param requirement The validation function.
 ...
 * @returns A some item action.
 */
declare function someItem<TInput extends readonly unknown[], const TMessage extends ErrorMessage<SomeItemIssue<TInput>> | undefined>(requirement: ArrayRequirement<TInput>, message: TMessage): SomeItemAction<TInput, TMessage>;

/**
 * Array action type.
 */
type ArrayAction<TInput extends readonly unknown[]> = (itemA: TInput[number], itemB: TInput[number]) => number;
/**
 * Sort items action type.
 */
interface SortItemsAction<TInput extends readonly unknown[]> extends BaseTransformation<TInput, TInput, never> {
    /**
     * The action type.
     */
 ...
 */
declare function sortItems<TInput extends readonly unknown[]>(operation?: ArrayAction<TInput>): SortItemsAction<TInput>;
 ...
 * Reference type.
 */
type Reference = FunctionReference<any[], BaseSchema<unknown, unknown, BaseIssue<unknown>> | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>> | BaseValidation<unknown, unknown, BaseIssue<unknown>> | BaseValidationAsync<unknown, unknown, BaseIssue<unknown>> | BaseTransformation<unknown, unknown, BaseIssue<unknown>> | BaseTransformationAsync<unknown, unknown, BaseIssue<unknown>>>;
/**
 ...
 */
declare function entriesFromList<const TList extends readonly string[], const TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>>>(list: TList, schema: TSchema): Record<TList[number], TSchema>;
