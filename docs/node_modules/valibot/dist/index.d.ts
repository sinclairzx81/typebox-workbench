 ...
 * Enum type.
 */
type Enum<TOption extends string = string> = Readonly<[TOption, ...TOption[]]> | [TOption, ...TOption[]];

/**
 * Enum schema type.
 */
type EnumSchema<TEnum extends Enum, TOutput = TEnum[number]> = BaseSchema<TEnum[number], TOutput> & {
    schema: 'enum';
    enum: TEnum;
};
/**
 ...
 */
declare function enumType<TOption extends string, TEnum extends Enum<TOption>>(enumValue: TEnum, error?: string): EnumSchema<TEnum>;

/**
 * Enum schema async type.
 */
type EnumSchemaAsync<TEnum extends Enum, TOutput = TEnum[number]> = BaseSchemaAsync<TEnum[number], TOutput> & {
    schema: 'enum';
    enum: TEnum;
};
/**
 ...
 */
declare function enumTypeAsync<TOption extends string, TEnum extends Enum<TOption>>(enumValue: TEnum, error?: string): EnumSchemaAsync<TEnum>;
 ...
 */
declare function literal<TLiteral extends Literal>(literal: TLiteral, error?: string): LiteralSchema<TLiteral>;
 ...
 */
declare function literalAsync<TLiteral extends Literal>(literal: TLiteral, error?: string): LiteralSchemaAsync<TLiteral>;
 ...
 */
declare function symbol$1(error?: string): SymbolSchema;
 ...
 */
declare function tupleAsync<TTupleItems extends TupleShapeAsync>(items: TTupleItems, pipe?: PipeAsync<TupleOutput<TTupleItems, undefined>>): TupleSchemaAsync<TTupleItems>;
/**
 * Creates an async tuple schema.
 *
 * @param items The items schema.
 ...
 * @returns An async tuple schema.
 */
declare function tupleAsync<TTupleItems extends TupleShapeAsync>(items: TTupleItems, error?: string, pipe?: PipeAsync<TupleOutput<TTupleItems, undefined>>): TupleSchemaAsync<TTupleItems>;
/**
 * Creates an async tuple schema.
 *
 * @param items The items schema.
 ...
 * @returns An async tuple schema.
 */
declare function tupleAsync<TTupleItems extends TupleShapeAsync, TTupleRest extends BaseSchema | BaseSchemaAsync | undefined>(items: TTupleItems, rest: TTupleRest, pipe?: PipeAsync<TupleOutput<TTupleItems, TTupleRest>>): TupleSchemaAsync<TTupleItems, TTupleRest>;
/**
 * Creates an async tuple schema.
 *
 * @param items The items schema.
 ...
 * @returns An async tuple schema.
 */
declare function tupleAsync<TTupleItems extends TupleShapeAsync, TTupleRest extends BaseSchema | BaseSchemaAsync | undefined>(items: TTupleItems, rest: TTupleRest, error?: string, pipe?: PipeAsync<TupleOutput<TTupleItems, TTupleRest>>): TupleSchemaAsync<TTupleItems, TTupleRest>;
 ...
 */
declare function tuple<TTupleItems extends TupleShape>(items: TTupleItems, pipe?: Pipe<TupleOutput<TTupleItems, undefined>>): TupleSchema<TTupleItems>;
/**
 * Creates a tuple schema.
 *
 * @param items The items schema.
 ...
 * @returns A tuple schema.
 */
declare function tuple<TTupleItems extends TupleShape>(items: TTupleItems, error?: string, pipe?: Pipe<TupleOutput<TTupleItems, undefined>>): TupleSchema<TTupleItems>;
/**
 * Creates a tuple schema.
 *
 * @param items The items schema.
 ...
 * @returns A tuple schema.
 */
declare function tuple<TTupleItems extends TupleShape, TTupleRest extends BaseSchema>(items: TTupleItems, rest: TTupleRest, pipe?: Pipe<TupleOutput<TTupleItems, TTupleRest>>): TupleSchema<TTupleItems, TTupleRest>;
/**
 * Creates a tuple schema.
 *
 * @param items The items schema.
 ...
 * @returns A tuple schema.
 */
declare function tuple<TTupleItems extends TupleShape, TTupleRest extends BaseSchema>(items: TTupleItems, rest: TTupleRest, error?: string, pipe?: Pipe<TupleOutput<TTupleItems, TTupleRest>>): TupleSchema<TTupleItems, TTupleRest>;
 ...
 * Parse info type.
 */
type ParseInfo = Partial<Pick<Issue, 'origin' | 'abortEarly' | 'abortPipeEarly'>>;
/**
 * Path item type.
 */
 ...
 * @returns Flat errors.
 */
declare function flatten(issues: Issues): FlatErrors;
 ...
 * Brand type.
 */
type Brand<TBrandName extends BrandName> = {
    [symbol]: TBrandName;
};
declare function brand<TSchema extends AnySchema, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): AnySchema<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends AnySchemaAsync, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): AnySchemaAsync<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends ArraySchema<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): ArraySchema<TSchema['array']['item'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends ArraySchemaAsync<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): ArraySchemaAsync<TSchema['array']['item'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends BigintSchema, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): BigintSchema<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends BigintSchemaAsync, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): BigintSchemaAsync<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends BlobSchema, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): BlobSchema<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends BlobSchemaAsync, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): BlobSchemaAsync<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends BooleanSchema, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): BooleanSchema<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends BooleanSchemaAsync, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): BooleanSchemaAsync<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends DateSchema, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): DateSchema<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends DateSchemaAsync, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): DateSchemaAsync<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends EnumSchema<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): EnumSchema<TSchema['enum'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends EnumSchemaAsync<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): EnumSchemaAsync<TSchema['enum'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends InstanceSchema<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): InstanceSchema<TSchema['class'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends InstanceSchemaAsync<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): InstanceSchemaAsync<TSchema['class'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends LiteralSchema<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): LiteralSchema<TSchema['literal'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends LiteralSchemaAsync<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): LiteralSchemaAsync<TSchema['literal'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends MapSchema<any, any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): MapSchema<TSchema['map']['key'], TSchema['map']['value'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends MapSchemaAsync<any, any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): MapSchemaAsync<TSchema['map']['key'], TSchema['map']['value'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends NanSchema, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): NanSchema<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends NanSchemaAsync, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): NanSchemaAsync<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends NativeEnumSchema<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): NativeEnumSchema<TSchema['nativeEnum'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends NativeEnumSchemaAsync<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): NativeEnumSchemaAsync<TSchema['nativeEnum'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends NeverSchema>(schema: TSchema, action: (value: Output<TSchema>) => never): NeverSchema;
declare function brand<TSchema extends NeverSchemaAsync>(schema: TSchema, action: (value: Output<TSchema>) => never): NeverSchemaAsync;
declare function brand<TSchema extends NonNullableSchema<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): NonNullableSchema<TSchema['wrapped'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends NonNullableSchemaAsync<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): NonNullableSchemaAsync<TSchema['wrapped'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends NonNullishSchema<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): NonNullishSchema<TSchema['wrapped'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends NonNullishSchemaAsync<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): NonNullishSchemaAsync<TSchema['wrapped'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends NonOptionalSchema<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): NonOptionalSchema<TSchema['wrapped'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends NonOptionalSchemaAsync<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): NonOptionalSchemaAsync<TSchema['wrapped'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends NullSchema, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): NullSchema<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends NullSchemaAsync, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): NullSchemaAsync<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends NullableSchema<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): NullableSchema<TSchema['wrapped'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends NullableSchemaAsync<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): NullableSchemaAsync<TSchema['wrapped'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends NullishSchema<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): NullishSchema<TSchema['wrapped'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends NullishSchemaAsync<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): NullishSchemaAsync<TSchema['wrapped'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends NumberSchema, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): NumberSchema<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends NumberSchemaAsync, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): NumberSchemaAsync<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends ObjectSchema<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): ObjectSchema<TSchema['object'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends ObjectSchemaAsync<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): ObjectSchemaAsync<TSchema['object'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends OptionalSchema<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): OptionalSchema<TSchema['wrapped'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends OptionalSchemaAsync<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): OptionalSchemaAsync<TSchema['wrapped'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends RecordSchema<any, any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): RecordSchema<TSchema['record']['key'], TSchema['record']['value'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends RecordSchemaAsync<any, any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): RecordSchemaAsync<TSchema['record']['key'], TSchema['record']['value'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends RecursiveSchema<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): RecursiveSchema<TSchema['getter'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends RecursiveSchemaAsync<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): RecursiveSchemaAsync<TSchema['getter'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends SetSchema<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): SetSchema<TSchema['set']['value'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends SetSchemaAsync<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): SetSchemaAsync<TSchema['set']['value'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends SpecialSchema<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): SpecialSchema<Input<TSchema>, Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends SpecialSchemaAsync<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): SpecialSchemaAsync<Input<TSchema>, Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends StringSchema, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): StringSchema<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends StringSchemaAsync, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): StringSchemaAsync<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends SymbolSchema, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): SymbolSchema<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends SymbolSchemaAsync, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): SymbolSchemaAsync<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends TupleSchema<any, any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): TupleSchema<TSchema['tuple']['items'], TSchema['tuple']['rest'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends TupleSchemaAsync<any, any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): TupleSchemaAsync<TSchema['tuple']['items'], TSchema['tuple']['rest'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends UndefinedSchema, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): UndefinedSchema<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends UndefinedSchemaAsync, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): UndefinedSchemaAsync<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends UnionSchema<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): UnionSchema<TSchema['union'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends UnionSchemaAsync<any>, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): UnionSchemaAsync<TSchema['union'], Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends UnknownSchema, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): UnknownSchema<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends UnknownSchemaAsync, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): UnknownSchemaAsync<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends VoidSchema, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): VoidSchema<Output<TSchema> & Brand<TBrandName>>;
declare function brand<TSchema extends VoidSchemaAsync, TBrandName extends BrandName>(schema: TSchema, name: TBrandName): VoidSchemaAsync<Output<TSchema> & Brand<TBrandName>>;
 ...
 * @returns The passed schema.
 */
declare function fallback<TSchema extends BaseSchema>(schema: TSchema, value: Output<TSchema> | ((info: FallbackInfo) => Output<TSchema>)): TSchema;
 ...
 * @returns The passed schema.
 */
declare function fallbackAsync<TSchema extends BaseSchema | BaseSchemaAsync>(schema: TSchema, value: Output<TSchema> | ((info: FallbackInfo) => Output<TSchema>)): TSchema;
 ...
 * @returns An async object schema.
 */
declare function partialAsync<TObjectSchema extends ObjectSchema<any> | ObjectSchemaAsync<any>>(schema: TObjectSchema, pipe?: PipeAsync<ObjectOutput<Partial$1<TObjectSchema['object']>>>): ObjectSchemaAsync<Partial$1<TObjectSchema['object']>>;
/**
 * Creates an async object schema consisting of all properties of an existing
 * object schema set to optional.
 *
 ...
 * @returns An async object schema.
 */
declare function partialAsync<TObjectSchema extends ObjectSchema<any> | ObjectSchemaAsync<any>>(schema: TObjectSchema, error?: string, pipe?: PipeAsync<ObjectOutput<Partial$1<TObjectSchema['object']>>>): ObjectSchemaAsync<Partial$1<TObjectSchema['object']>>;
 ...
 * @returns An async object schema.
 */
declare function requiredAsync<TObjectSchema extends ObjectSchema<any> | ObjectSchemaAsync<any>>(schema: TObjectSchema, pipe?: PipeAsync<ObjectOutput<Required<TObjectSchema['object']>>>): ObjectSchemaAsync<Required<TObjectSchema['object']>>;
/**
 * Creates an async object schema consisting of all properties of an existing
 * object schema set to none optional.
 *
 ...
 * @returns An async object schema.
 */
declare function requiredAsync<TObjectSchema extends ObjectSchema<any> | ObjectSchemaAsync<any>>(schema: TObjectSchema, error?: string, pipe?: PipeAsync<ObjectOutput<Required<TObjectSchema['object']>>>): ObjectSchemaAsync<Required<TObjectSchema['object']>>;
 ...
 * @returns The parsed output.
 */
declare function safeParse<TSchema extends BaseSchema>(schema: TSchema, input: unknown, info?: Pick<ParseInfo, 'abortEarly' | 'abortPipeEarly'>): SafeParseResult<TSchema>;
 ...
 * @returns The parsed output.
 */
declare function safeParseAsync<TSchema extends BaseSchema | BaseSchemaAsync>(schema: TSchema, input: unknown, info?: Pick<ParseInfo, 'abortEarly' | 'abortPipeEarly'>): Promise<SafeParseResult<TSchema>>;
...
declare function transform<TSchema extends BlobSchema, TOutput>(schema: TSchema, action: (value: Output<TSchema>) => TOutput): BlobSchema<TOutput>;
...
declare function transform<TSchema extends InstanceSchema<any>, TOutput>(schema: TSchema, action: (value: Output<TSchema>) => TOutput): InstanceSchema<TSchema['class'], TOutput>;
...
declare function transform<TSchema extends SpecialSchema<any>, TOutput>(schema: TSchema, action: (value: Output<TSchema>) => TOutput): SpecialSchema<Input<TSchema>, TOutput>;
...
declare function transformAsync<TSchema extends BlobSchema | BlobSchemaAsync, TOutput>(schema: TSchema, action: (value: Output<TSchema>) => TOutput | Promise<TOutput>): BlobSchemaAsync<TOutput>;
...
declare function transformAsync<TSchema extends SpecialSchema<any> | SpecialSchemaAsync<any>, TOutput>(schema: TSchema, action: (value: Output<TSchema>) => TOutput | Promise<TOutput>): SpecialSchemaAsync<Input<TSchema>, TOutput>;
 ...
 */
declare function getDefaultArgs<TPipe extends Pipe<any> | PipeAsync<any>>(arg1: string | TPipe | undefined, arg2: TPipe | undefined): [string | undefined, TPipe | undefined];
 ...
 */
declare function getIssues(info: ParseInfo | undefined, reason: IssueReason, validation: string, message: string, input: unknown, issues?: Issues): {
    issues: Issues;
};
 ...
 */
declare function bytes<TInput extends string>(requirement: number, error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function custom<TInput>(requirement: (input: TInput) => boolean, error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 */
declare function customAsync<TInput>(requirement: (input: TInput) => Promise<boolean>, error?: string): (input: TInput) => Promise<PipeResult<TInput>>;
 ...
 * @returns A validation function.
 */
declare function email<TInput extends string>(error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function emoji<TInput extends string>(error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function endsWith<TInput extends string>(requirement: string, error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function equal<TInput extends string | number | bigint | boolean, TRequirement extends TInput>(requirement: TRequirement, error?: string): (input: TInput) => PipeResult<TInput>;

declare function excludes<TInput extends string>(requirement: string, error?: string): (input: TInput) => PipeResult<TInput>;
declare function excludes<TInput extends TItem[], TItem>(requirement: TItem, error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function finite<TInput extends number>(error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function imei<TInput extends string>(error?: string): (input: TInput) => PipeResult<TInput>;

declare function includes<TInput extends string>(requirement: string, error?: string): (input: TInput) => PipeResult<TInput>;
declare function includes<TInput extends TItem[], TItem>(requirement: TItem, error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function integer<TInput extends number>(error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function ip<TInput extends string>(error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function ipv4<TInput extends string>(error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function ipv6<TInput extends string>(error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function isoDate<TInput extends string>(error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function isoDateTime<TInput extends string>(error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function isoTime<TInput extends string>(error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function isoTimeSecond<TInput extends string>(error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function isoTimestamp<TInput extends string>(error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function isoWeek<TInput extends string>(error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function length<TInput extends string | any[]>(requirement: number, error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function maxBytes<TInput extends string>(requirement: number, error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function maxLength<TInput extends string | any[]>(requirement: number, error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function maxSize<TInput extends Map<any, any> | Set<any> | Blob>(requirement: number, error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function maxValue<TInput extends string | number | bigint | Date, TRequirement extends TInput>(requirement: TRequirement, error?: string): (input: TInput) => PipeResult<TInput>;
/**
 * See {@link maxValue}
 *
 ...
 * @returns A validation function.
 */
declare function minBytes<TInput extends string>(requirement: number, error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function mimeType<TInput extends Blob>(requirement: `${string}/${string}`[], error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function minLength<TInput extends string | any[]>(requirement: number, error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function minSize<TInput extends Map<any, any> | Set<any> | Blob>(requirement: number, error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function minValue<TInput extends string | number | bigint | Date, TRequirement extends TInput>(requirement: TRequirement, error?: string): (input: TInput) => PipeResult<TInput>;
/**
 * See {@link minValue}
 *
 ...
 * @returns A validation function.
 */
declare function multipleOf<TInput extends number>(requirement: number, error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function regex<TInput extends string>(requirement: RegExp, error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function safeInteger<TInput extends number>(error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function size<TInput extends Map<any, any> | Set<any> | Blob>(requirement: number, error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function startsWith<TInput extends string>(requirement: string, error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function url<TInput extends string>(error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function uuid<TInput extends string>(error?: string): (input: TInput) => PipeResult<TInput>;
 ...
 * @returns A validation function.
 */
declare function value<TInput extends string | number | bigint, TRequirement extends TInput>(requirement: TRequirement, error?: string): (input: TInput) => PipeResult<TInput>;

export { AnySchema, AnySchemaAsync, ArrayPathItem, ArraySchema, ArraySchemaAsync, BaseSchema, BaseSchemaAsync, BigintSchema, BigintSchemaAsync, BlobSchema, BlobSchemaAsync, BooleanSchema, BooleanSchemaAsync, Class, DateSchema, DateSchemaAsync, Enum, EnumSchema, EnumSchemaAsync, FlatErrors, Input, InstanceSchema, InstanceSchemaAsync, Issue, IssueOrigin, IssueReason, Issues, Literal, LiteralSchema, LiteralSchemaAsync, MapInput, MapOutput, MapPathItem, MapSchema, MapSchemaAsync, NanSchema, NanSchemaAsync, NativeEnum, NativeEnumSchema, NativeEnumSchemaAsync, NeverSchema, NeverSchemaAsync, NonNullable$1 as NonNullable, NonNullableSchema, NonNullableSchemaAsync, NonNullish, NonNullishSchema, NonNullishSchemaAsync, NonOptional, NonOptionalSchema, NonOptionalSchemaAsync, NullSchema, NullSchemaAsync, NullableSchema, NullableSchemaAsync, NullishSchema, NullishSchemaAsync, NumberSchema, NumberSchemaAsync, ObjectInput, ObjectOutput, ObjectPathItem, ObjectSchema, ObjectSchemaAsync, ObjectShape, ObjectShapeAsync, OptionalSchema, OptionalSchemaAsync, Output, ParseInfo, PathItem, Pipe, PipeAsync, PipeInfo, PipeResult, RecordInput, RecordKey, RecordKeyAsync, RecordOutput, RecordPathItem, RecordSchema, RecordSchemaAsync, RecursiveSchema, RecursiveSchemaAsync, ResolveObject, SafeParseResult, SetInput, SetOutput, SetPathItem, SetSchema, SetSchemaAsync, SpecialSchema, SpecialSchemaAsync, StringSchema, StringSchemaAsync, SymbolSchema, SymbolSchemaAsync, TupleInput, TupleOutput, TuplePathItem, TupleSchema, TupleSchemaAsync, TupleShape, TupleShapeAsync, UndefinedSchema, UndefinedSchemaAsync, UnionOptions, UnionOptionsAsync, UnionSchema, UnionSchemaAsync, UnknownSchema, UnknownSchemaAsync, ValiError, VoidSchema, VoidSchemaAsync, _ParseResult, any, anyAsync, array, arrayAsync, bigint, bigintAsync, blob, blobAsync, boolean, booleanAsync, brand, bytes, coerce, coerceAsync, custom, customAsync, date, dateAsync, email, emoji, endsWith, enumType, enumTypeAsync, equal, excludes, executePipe, executePipeAsync, fallback, fallbackAsync, finite, flatten, getDefaultArgs, getIssues, imei, includes, instance, instanceAsync, integer, ip, ipv4, ipv6, is, isLuhnAlgo, isoDate, isoDateTime, isoTime, isoTimeSecond, isoTimestamp, isoWeek, keyof, length, literal, literalAsync, map, mapAsync, maxBytes, maxLength, maxRange, maxSize, maxValue, merge, mergeAsync, mimeType, minBytes, minLength, minRange, minSize, minValue, multipleOf, nan, nanAsync, nativeEnum, nativeEnumAsync, never, neverAsync, nonNullable, nonNullableAsync, nonNullish, nonNullishAsync, nonOptional, nonOptionalAsync, nullType, nullTypeAsync, nullable, nullableAsync, nullish, nullishAsync, number, numberAsync, object, objectAsync, omit, omitAsync, optional, optionalAsync, parse, parseAsync, partial, partialAsync, pick, pickAsync, record, recordAsync, recursive, recursiveAsync, regex, required, requiredAsync, safeInteger, safeParse, safeParseAsync, set, setAsync, size, special, specialAsync, startsWith, strict, strictAsync, string, stringAsync, symbol$1 as symbol, symbolAsync, toCustom, toCustomAsync, toLowerCase, toMaxValue, toMinValue, toTrimmed, toTrimmedEnd, toTrimmedStart, toUpperCase, transform, transformAsync, tuple, tupleAsync, undefinedType, undefinedTypeAsync, union, unionAsync, unknown, unknownAsync, unwrap, url, useDefault, uuid, value, voidType, voidTypeAsync, withDefault };
