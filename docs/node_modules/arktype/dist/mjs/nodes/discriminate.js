...
export const flattenBranches = (branches, ctx)=>{
...
export const serializeDefinitionIfAllowed = (kind, definition)=>{
    switch(kind){
        case "value":
...
const serializeIfPrimitive = (data)=>{
    ...
    return domain === "object" || domain === "symbol" ? undefined : serializePrimitive(data);
};
const serializeData = {
...
export const serializeCase = (kind, data)=>serializeData[kind](data);
