...
export declare const entriesOf: <o extends object>(o: o) => ({ [k_1 in keyof o]-?: [k_1, Exclude<o[k_1], undefined>]; }[o extends List<unknown> ? keyof o & number : keyof o] extends infer T ? { [k in keyof T]: { [k_1 in keyof o]-?: [k_1, Exclude<o[k_1], undefined>]; }[o extends List<unknown> ? keyof o & number : keyof o][k]; } : never)[];
